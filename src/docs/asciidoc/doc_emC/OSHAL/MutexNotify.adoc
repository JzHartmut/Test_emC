...
.Cpp: including of `specific_OSemc.h` in all emC/OSAL/*OSemC.h header
[source,Cpp]
----
//in emC/OSAL/sync_OSemC.h:
include::../../../../src_emC/cpp/emC/OSAL/sync_OSemC.h[tag=specific_OSemc]
----
...
It means the include include path should be set adequate to this directory.


==== Mutex

The file `specific_OSemc.h` contains the definition of:
