...
=== Getting git archives, or sources from git archive
...
After cloning you should adjust the time stamps of all files to the originals, 
...
This is recommended if you want to use the same version of emC sources for more as one project,
for example to work with embedded platforms.

If you want to use a mirror location for the git repository 
(see link:../../../Git/html/GitUsage.html[vishia.org/Git/html/GitUsage.html]
then you do the same with the other repository too:

 git clone https://github.com/JzHartmut/src_emC.git

The using of a mirror location is recommended also if you want to use 
only a part of the emC files in specific embedded projects.

As described in link:../../../Git/html/GitUsage.html[vishia.org/Git/html/GitUsage.html]
you should have some additional files to clean the repository and especially get the correct time stamps of files, see next.
