...
int testMult16_Math_emC ( Test_Data16_Math_emC_s*  values, int zValues) {
  int err1 = 0, err2=0;
  TEST_START("muls16_emC and mulu16_emC: platform depending MACROs are correct");
...
int testMult32Lo_Math_emC ( Test_Data16_Math_emC_s*  values, int zValues) {
  int err1 = 0, err2=0;
  TEST_START("mul32lo_emC: platform depending MACROs are correct");
  for(int ix=0; ix < zValues; ++ix) {
...
int testMult32_Math_emC ( Test_Data16_Math_emC_s*  values, int zValues ) {
  ...
  TEST_START("muls32hi_emC and mulu32hi_emC: platform depending MACROs are correct");
...
int test_AddSat_Math_emC ( Test_Data16_Math_emC_T* data, int zData) {
  int ret = 0;
  TEST_START("adds16sat_emC and addu16sat_emC: platform depending MACROs are correct");
