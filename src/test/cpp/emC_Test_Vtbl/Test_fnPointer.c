#include <applstdef_emC.h>
 ...
 void test_fnPointer() {
   ...
   MAYBE_UNUSED_emC void* voidX = (void*)pointer_to_operation;


   pointer_to_B = myOperationXyz;

   MAYBE_UNUSED_emC float result = pointer_to_operation(3.14f);

   result = pointer_to_B(4.5f);

   //cast test:
   void* void_a = (void*)pointer_to_operation;
   MAYBE_UNUSED_emC MT_myOperation* pointer_to_A2 = (MT_myOperation*) void_a;
   ...
   MAYBE_UNUSED_emC MT_myOperation_B pointer_to_B2 = (MT_myOperation_B) void_B;
